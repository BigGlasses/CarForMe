...
$.getJSON('http://localhost:8080/vehicles/tags', { get_param: 'value' }, function(data) {
	countries = data;
	var cList = $('#tagList')
...
function doRequest(){
	var aaa = $("#sitelogo");
  	...
  	if (aaa.hasClass( "wobble" )) aaa.removeClass("wobble");
	wanted = "";
	unWanted = "";
	var tagList = $('.tagD')
	...
	//$.getJSON('http://localhost:8080/vehicles/search?budget=' + budget + '&wantFields=' + wanted + '&dontWantField=' + unWanted, { get_param: 'value' }, function(data) {
		
		var cList = $('#carList')
		cList.html('');
		data = [{"manufacturer":"chevrolet", "gasPerYear":"2200.00","model":"k1500 pickup 4wd","image":"http://cgi.chevrolet.com/mmgprod-us/dynres/prove/image.gen?i=2017/CK15543/CK15543__2LZ/G1K_H2U_RD1gmds6.jpg&v=deg01&std=true&country=US","cost":1055.0},
		...
		$.each(data, function(i){
			var li = $('<div/>')
			.addClass('col-md-4 tCenter carHolder animated fadeInLeft')
			.appendTo(cList);
			var aaa = $('<img/>')
